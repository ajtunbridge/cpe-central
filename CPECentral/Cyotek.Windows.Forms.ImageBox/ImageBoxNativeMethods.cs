...
namespace Cyotek.Windows.Forms
{
        ...
        // ReSharper restore ClassNeverInstantiated.Global
    {
        ...
        public static extern int GetScrollInfo(IntPtr hwnd, int bar,
            [MarshalAs(UnmanagedType.LPStruct)] SCROLLINFO scrollInfo);

        [DllImport("user32.dll", SetLastError = true)]
        public static extern uint GetWindowLong(IntPtr hwnd, int index);

        [DllImport("user32.dll")]
        public static extern int SetScrollInfo(IntPtr hwnd, int bar,
            [MarshalAs(UnmanagedType.LPStruct)] SCROLLINFO scrollInfo, bool redraw);
