...
namespace ICSharpCode.AvalonEdit.Document
{
    ...
    public sealed class TextSegmentCollection<T> : ICollection<T>, ISegmentTree, IWeakEventListener
        where T : TextSegment
    {
        ...
        ///     <see cref="UpdateOffsets(DocumentChangeEventArgs)" />.
        /// </summary>
        ...
        private void CheckNodeProperties(TextSegment node, TextSegment parentNode, bool parentColor, int blackCount,
