...
namespace ICSharpCode.AvalonEdit.Document
{
    ...
    public interface ITextSource
    {
        ...
        /// </summary>
        /// <remarks>
        ///     This method is generally not thread-safe when called on a mutable text buffer, but the resulting text buffer is
        ///     immutable and thread-safe.
        ///     However, some implementing classes may provide additional thread-safety guarantees, see
        ///     <see cref="TextDocument.CreateSnapshot()">TextDocument.CreateSnapshot</see>.
        /// </remarks>
    ...
    {
        private readonly ITextSource baseTextSource;
        private readonly ISegment viewedSegment;
        ...
        public string Text
        {
            get { return baseTextSource.GetText(viewedSegment.Offset, viewedSegment.Length); }
        }
    ...
    public sealed class StringTextSource : ITextSource
    {
        ...
        event EventHandler ITextSource.TextChanged
        {
            add { }
            remove { }
        }
        ...
        public char GetCharAt(int offset)
        {
            ...
            if (offset < 0 || offset >= text.Length) {
                throw new ArgumentOutOfRangeException("offset", offset,
                    "offset must be between 0 and " + (text.Length - 1));
            }
            return text[offset];
        }
    ...
    public sealed class RopeTextSource : ITextSource
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate",
            Justification = "Not a property because it creates a clone")]
