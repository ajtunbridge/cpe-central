...
//		}
        ...
        private void BeforeNodeReplace(HeightTreeNode removedNode, HeightTreeNode newNode,
        ...
        {
            get { return root.totalCount; }
        }

        public double TotalHeight
        {
            get { return root.totalHeight; }
        }
        ...
        private void CheckProperties(HeightTreeNode node)
        {
            ...
            if (node.left != null && node.right != null) {
                if (node.left.collapsedSections != null && node.right.collapsedSections != null) {
                    IEnumerable<CollapsedLineSection> intersection = Enumerable.Intersect(node.left.collapsedSections,
                        node.right.collapsedSections);
        ...
        /// </summary>
        private static void CheckAllContainedIn(IEnumerable<CollapsedLineSection> list1,
            ICollection<CollapsedLineSection> list2)
        {
            if (list1 == null) {
        ...
        private void CheckNodeProperties(HeightTreeNode node, HeightTreeNode parentNode, bool parentColor,
        ...
        private static void AddRemoveCollapsedSectionDown(CollapsedLineSection section, HeightTreeNode node,
            int sectionLength, bool add)
        {
            while (true) {
                if (node.left != null) {
