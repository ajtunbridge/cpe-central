...
namespace ICSharpCode.AvalonEdit.Rendering
{
    ...
    public interface ITextRunConstructionContext
    {
        ...
        ///     It does this by returning a <see cref="StringSegment" /> that describes the requested segment within the returned
        ///     string.
        ///     This method should be the preferred text access method in the text transformation pipeline, as it can avoid
        ///     repeatedly allocating string instances
