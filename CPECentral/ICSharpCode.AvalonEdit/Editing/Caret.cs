...
namespace ICSharpCode.AvalonEdit.Editing
{
    ...
    public sealed class Caret
    {
        ...
        private void RevalidateVisualColumn(VisualLine visualLine)
        {
            ...
            int newVisualColumnForwards = visualLine.GetNextCaretPosition(position.VisualColumn - 1,
                LogicalDirection.Forward, CaretPositioningMode.Normal, textArea.Selection.EnableVirtualSpace);
            ...
            if (newVisualColumnForwards != position.VisualColumn) {
                ...
                int newVisualColumnBackwards = visualLine.GetNextCaretPosition(position.VisualColumn + 1,
                    LogicalDirection.Backward, CaretPositioningMode.Normal, textArea.Selection.EnableVirtualSpace);
                ...
                if (newVisualColumnBackwards >= 0) {
                    newOffsetBackwards = visualLine.GetRelativeOffset(newVisualColumnBackwards) +
                                         firstDocumentLineOffset;
                }
                else {
        ...
        public Rect CalculateCaretRectangle()
        {
            if (textView != null && textView.Document != null) {
                VisualLine visualLine =
                    textView.GetOrConstructVisualLine(textView.Document.GetLineByNumber(position.Line));
