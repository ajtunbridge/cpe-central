    ...
    public abstract class Selection
    {
        ...
        private bool IsInVirtualSpace(TextViewPosition pos)
        {
            return pos.VisualColumn >
                   textArea.TextView.GetOrConstructVisualLine(textArea.Document.GetLineByNumber(pos.Line)).VisualLength;
        }
        ...
        /// </summary>
        public abstract Selection StartSelectionOrSetEndpoint(TextViewPosition startPosition,
        ...
        public virtual DataObject CreateDataObject(TextArea textArea)
        {
            ...
            var data = new DataObject(TextUtilities.NormalizeNewLines(text, Environment.NewLine));
