...
namespace ICSharpCode.AvalonEdit.Highlighting
{
    ...
    public static class HtmlClipboard
    {
        ...
        public static void SetHtml(DataObject dataObject, string htmlFragment)
        {
            ...
            string htmlEnd = "<!--EndFragment-->" + Environment.NewLine + "</BODY>" + Environment.NewLine + "</HTML>" +
                             Environment.NewLine;
            ...
            string cf_html = BuildHeader(startHTML, endHTML, startFragment, endFragment) + htmlStart + htmlFragment +
                             htmlEnd;
        ...
        ///     The highlighter used to highlight the document. <c>null</c> is valid and will create HTML
        ///     without any highlighting.
        /// </param>
        /// <param name="segment">
        ///     The part of the document to create HTML for. You can pass <c>null</c> to create HTML for the
        ///     whole document.
        /// </param>
        /// <param name="options">The options for the HTML creation.</param>
        /// <returns>HTML code for the document part.</returns>
        public static string CreateHtmlFragment(TextDocument document, IHighlighter highlighter, ISegment segment,
            HtmlOptions options)
        {
            if (document == null) {
