...
namespace ICSharpCode.AvalonEdit.Highlighting
{
    ...
    public class HighlightingColorizer : DocumentColorizingTransformer
    {
        ...
        /// <param name="ruleSet">The root highlighting rule set.</param>
        [Obsolete(
            "The TextView parameter is no longer used, please use the constructor taking only HighlightingRuleSet instead"
            )]
        [SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "textView")]
        ...
        private void OnDocumentChanged(TextView textView)
        {
        ...
        {
            var highlighter = ((TextView) sender).Services.GetService(typeof (IHighlighter)) as IHighlighter;
            if (highlighter != null) {
        ...
        protected override void Colorize(ITextRunConstructionContext context)
        {
            ...
            if (lastColorizedLine != context.VisualLine.LastDocumentLine) {
                var highlighter = context.TextView.Services.GetService(typeof (IHighlighter)) as IHighlighter;
                if (highlighter != null) {
        ...
        #region Nested type: TextViewDocumentHighlighter
        ...
        private sealed class TextViewDocumentHighlighter : DocumentHighlighter
        {
            ...
            public TextViewDocumentHighlighter(HighlightingColorizer colorizer, TextView textView, TextDocument document,
                HighlightingRuleSet baseRuleSet)
